...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install -y ca-certificates tini binutils curl clang binutils clang-19 && rm -rf /var/lib/apt/lists/*
